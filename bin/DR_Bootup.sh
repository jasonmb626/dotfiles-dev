...
task add proj:org.DR eff:1m sched:sod+8h unt:sched+8h Choose top 3 projects for the day
task add proj:org.DR eff:1m sched:sod+8h unt:sched+8h $(date +%Y-%m-%d) - Transfer notes from phone list
task add proj:org.DR eff:30m sched:sod+8h unt:sched+8h $(date +%Y-%m-%d) - Daily Review
